...
const columns = [
  ...
  { id: 'femap154', numeric: false, disablePadding: false, label: 'FEMA P-154' },
  { id: 'atc20r', numeric: false, disablePadding: false, label: 'ATC20 Rapid' },
  { id: 'atc20d', numeric: false, disablePadding: false, label: 'ATC20 D' },
];
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        <IconButton aria-label="atc20r edit or add">
                          { n.atc20r ? <EditIcon /> : <AddBoxIcon /> }
                        </IconButton>
                      </TableCell>
                      <TableCell align="left">
                        <IconButton aria-label="atc20d edit or add">
                          { n.atc20d ? <EditIcon /> : <AddBoxIcon /> }
                        </IconButton>
                      </TableCell>
                    </TableRow>
                  );
